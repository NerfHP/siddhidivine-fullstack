          ...
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 50, opacity: 0 }}
            ...
            <div className="hidden md:flex flex-col justify-center p-8 text-white">
                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="flex items-center gap-4 bg-white/10 p-4 rounded-lg"><Repeat size={32} className="text-yellow-400 shrink-0"/><div><h3 className="font-semibold">Unlock Your Harmony</h3><p className="text-sm text-white/80">Effortless access to personalized guidance.</p></div></div>
